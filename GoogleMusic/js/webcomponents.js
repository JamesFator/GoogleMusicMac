...
if (WebComponents.flags.shadow) {
    ...
    (function(scope) {
        ...
        function getWrapperConstructor(node) {
            var nativePrototype = Object.getPrototypeOf(node);
        ...
        scope.isIe = /Trident|Edge/.test(navigator.userAgent);
        var dummyDescriptor = {
            get: function() {},
            set: function(v) {},
            configurable: true,
    ...
    (function(scope) {
        ...
        var removeChildOriginalHelper = scope.isIe ? function(parent, child) {
            try {
